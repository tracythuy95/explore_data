...
def main():
    ...
    w_leggings = 'https://shop.lululemon.com/c/womens-leggings/_/N-8s6'
    w_hoodies = 'https://shop.lululemon.com/c/womens-outerwear/_/N-8s4'
    ...
    for page_url in page_url_list:
        ...
        # pickle.dump(df, open( "20210125_leggings", "wb" ) )
        ...
        # pickle.dump(merge_df, open( "20210125_product_review_material", "wb" ) )
        print('done!!')
        dfs.append(merge_df)
